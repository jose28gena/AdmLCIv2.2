...
namespace AdmLCI
{
    public partial class admonUsuarios : Form
    {
        ...
        public void cargarUsuarios() {
            dtUsr = con.consultaLibreDT("SELECT Usuario.usr_nombre AS 'Nombre', Usuario.usr_usuario AS 'Usuario',Tipo_Usuario.tpusr_descr AS 'Tipo de usuario' FROM Usuario INNER JOIN Tipo_Usuario on Usuario.tpusr_id=Tipo_Usuario.tpusr_id");
