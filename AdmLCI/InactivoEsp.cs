...
namespace AdmLCI
{
    public partial class InactivoEsp: Form
    {
...

{
      ...
      return isNumber;
        ...
        public InactivoEsp(Lista_especiales e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (!(String.IsNullOrEmpty(textBox6.Text)))
            {
                if (IsNumeric(textBox6.Text))
                {
                    ...
                    abrir.modificar("UPDATE AlumnoEspecial SET ales_estado = 'Inactivo' WHERE ales_id =" + textBox6.Text +"or ales_exp_ext="+textBox6.Text);
                }
                else 
                {
                    abrir.modificar("UPDATE AlumnoEspecial SET ales_estado = 'Inactivo' WHERE ales_exp_ext ='" + textBox6.Text + "'");
                }
